...
/*
  ...
  ==> Crie um número aleatório de 0 à 100 e o exiba ao usuário. Peça ao usuário que digite um múltiplo do
  número aleatório. Somente saia do laço caso o usuário informe um número correto.
*/
